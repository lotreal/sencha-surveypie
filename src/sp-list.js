 ...
 * @xtype list
 */
Surveypie.List = Ext.extend(Ext.DataView, {
    cmpCls: 'x-list',
    ...
    initComponent : function() {
        ...
        if (this.indexBar) {
            ...
            this.indexBar = Ext.ComponentMgr.create(indexBarConfig);
            //console.log(this.dockedItems);
            if (this.dockedItems) {
                this.addDocked(this.indexBar);
            } else {
                this.dockedItems = [];
    ...
    onRender : function() {
        ...
        Surveypie.List.superclass.onRender.apply(this, arguments);
    },
    ...
    updateItems : function() {
        Surveypie.List.superclass.updateItems.apply(this, arguments);
        this.updateOffsets();
    },

    afterLayout : function() {
        Surveypie.List.superclass.afterLayout.apply(this, arguments);
        this.updateOffsets();
    },
    ...
    onScroll : function(scroller, pos, options) {
        ...
        // if (this.indexBar) {
        //     this.indexStore.loadData([
        //         {firstName: 'Ed2',    lastName: 'Spencer'},
    ...
    onUpdate : function(ds, record) {
        if (this.grouped) {
            ...
            Surveypie.List.superclass.onUpdate.apply(this, arguments);
        }  
    },
    ...
    onAdd : function(ds, records, index) {
        if (this.grouped) {
            ...
            Surveypie.List.superclass.onAdd.apply(this, arguments);
        }
    },
    ...
    onRemove : function(ds, record, index) {
        if (this.grouped) {
            ...
            Surveypie.List.superclass.onRemove.apply(this, arguments);
        }
    }
});

Surveypie.EList = Ext.extend(Ext.List, {
    // @private
    initComponent : function() {
        if (this.indexer) {
            this.indexBar = false;
        ...
        Surveypie.EList.superclass.initComponent.call(this);
    },
    ...
    // @private
    initEvents : function() {
        Surveypie.EList.superclass.initEvents.call(this);
...
Ext.reg('sp_list', Surveypie.EList);
